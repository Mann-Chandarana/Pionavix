        ...
        <div className={`flex items-center justify-between transition-all duration-500 ${scrolled ? 'h-10' : 'h-12'}`}>
          ...
          <nav className="hidden lg:flex items-center space-x-6">
            {navigation.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-gray-200 hover:text-blue-400 transition-all duration-300 font-semibold relative group"
              >
                {item.name}
          ...
          <div className="lg:hidden flex items-center space-x-2">
            <Button
              ...
              className="border-gray-600 bg-gray-800/50 shadow-lg p-2 text-gray-200 hover:text-blue-400 hover:border-blue-500/50"
            >
            ...
            <nav className="flex flex-col space-y-3">
              {navigation.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-gray-200 hover:text-blue-400 transition-colors font-semibold py-1"
