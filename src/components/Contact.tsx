        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/5 backdrop-blur rounded-2xl p-6 hover:bg-white/10 transition-colors">
                ...
                <div className="text-blue-200 text-sm">hello@pionavix.com</div>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur rounded-2xl p-6 hover:bg-white/10 transition-colors">
                ...
                <div className="text-blue-200 text-sm">123 Innovation Street, Tech City, TC 12345</div>
              </div>
          ...
          <Card className="bg-white/10 backdrop-blur-md border-white/20 shadow-2xl">
            ...
            <CardContent className="space-y-6">
              ...
              <Textarea 
                ...
                rows={4}
                className="bg-white/10 border-white/30 text-white placeholder:text-blue-200 resize-none focus:border-white/50"
              />
