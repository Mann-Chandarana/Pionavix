...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-gray-50 to-blue-50">
      ...
      <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-r from-blue-100/50 to-indigo-100/50 rounded-full blur-3xl animate-float"></div>
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-indigo-100/50 to-blue-100/50 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10 animate-slide-left">
            <div className="space-y-6">
              <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-100 to-indigo-100 backdrop-blur-xl border border-blue-200 rounded-full text-blue-700 text-sm font-medium">
                <Zap className="h-4 w-4 mr-2" />
                Digital Innovation Experts
              </div>
              
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                <span ref={typedRef} className="bg-gradient-to-r from-gray-900 via-blue-800 to-indigo-800 bg-clip-text text-transparent"></span>
              </h1>
          ...
          <div className="relative animate-slide-right">
            <div className="relative">
              ...
              {/* Floating elements */}
              <div className="absolute -top-8 -right-8 w-20 h-20 bg-gradient-to-r from-blue-200/50 to-indigo-200/50 rounded-2xl blur-xl animate-float"></div>
              <div className="absolute -bottom-8 -left-8 w-16 h-16 bg-gradient-to-r from-indigo-200/50 to-blue-200/50 rounded-2xl blur-xl animate-float" style={{ animationDelay: '1s' }}></div>
            </div>
          </div>
        </div>
      </div>
