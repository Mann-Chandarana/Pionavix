  ...
  return (
    <section className={`relative min-h-screen flex items-center transition-all duration-1000 ${
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-10 w-40 h-40 bg-slate-500/5 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-3/4 left-1/3 w-24 h-24 bg-gray-500/5 rounded-full blur-2xl animate-pulse delay-500"></div>
      </div>
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              <div className={`inline-flex items-center px-4 py-2 rounded-full ${
                isDark ? 'bg-slate-800/50 text-blue-300' : 'bg-slate-700/50 text-blue-300'
